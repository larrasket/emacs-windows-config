...
(setq fill-column 92)
(setq org-directory "E:/leet/")


(setq org-agenda-files '("E:/leet/"))



;; (setq org-agenda-files (directory-files-recursively "/home/ghd/me/leet/" "\.org$")) ;
;;
;;
;;
...
(file-name-sans-extension  (file-name-nondirectory (buffer-file-name))) " && C:/msys64/usr/bin/rm.exe "
(file-name-sans-extension  (file-name-nondirectory (buffer-file-name)))
) t  ) (other-window t)
...
(setq org-journal-dir "E:/leet/journal/")
...
(setenv "PATH" (concat "C:/ripgrep;" (getenv "PATH")))
(setenv "PATH" (concat "C:/Program Files/Git/cmd;" (getenv "PATH")))
(setenv "PATH" (concat "C:/Program Files/LLVM/bin;" (getenv "PATH")))
(setenv "PATH" (concat "C:/msys64/mingw64/bin;" (getenv "PATH")))
(setenv "PATH" (concat "C:/msys64/mingw64/bin;" (getenv "PATH")))
(setenv "PATH" (concat "C:/Program Files/BraveSoftware/Brave-Browser/Application;" (getenv "PATH")))
(setenv "PATH" (concat "C:/Program Files/ImageMagick-7.1.0-Q16-HDRI;" (getenv "PATH")))
(setenv "PATH" (concat "C:/Users/ghd/.wakatime;" (getenv "PATH")))
